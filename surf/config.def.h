...
static char *fulluseragent  = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/605.1.15"; /* Or override the whole user agent string */
